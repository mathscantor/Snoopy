...
class Packet:
    ...
    def __return_application_layer(self):
        ...
        if self.__transport_layer.application_data is None or len(self.__transport_layer.application_data) == 0:
            return None
    ...
    def print_packet(self):
        ...
        if self.__link_layer.network_type == NetworkType.UNKNOWN or \
                self.__link_layer.network_type is None or \
                self.__network_layer is None:
        ...
        if self.__network_layer.transport_type == TransportType.UNKNOWN or \
                self.__network_layer.transport_type is None or \
                self.__transport_layer is None:
        ...
        if self.__transport_layer.application_type == ApplicationType.UNKNOWN or \
                self.__transport_layer.application_type is None or \
                self.__application_layer is None:
